        ...
        <b-sidebar id="sidebar-footer"
          ...
          <nav class="container-fluid mb-3">
            <b-row>
              ...
              <b-col cols="8">
                <div id="scrollspy-nested" style="position:relative; height:736px; overflow-y:auto">
